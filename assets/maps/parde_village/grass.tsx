...
<tileset version="1.10" tiledversion="1.11.2" name="grass" tilewidth="16" tileheight="16" tilecount="3600" columns="60">
 <image source="../../tilesets/forest/tileset_grass.png" width="960" height="960"/>
 <wangsets>
  <wangset name="dirt_path" type="corner" tile="63">
   ...
   <wangtile tileid="64" wangid="0,0,0,0,0,1,0,1"/>
   <wangtile tileid="65" wangid="0,0,0,1,0,1,0,1"/>
   <wangtile tileid="66" wangid="0,1,0,1,0,1,0,0"/>
   <wangtile tileid="122" wangid="0,1,0,0,0,0,0,0"/>
  ...
  <wangset name="grass" type="corner" tile="0">
   ...
   <wangtile tileid="122" wangid="0,0,0,1,0,1,0,1"/>
